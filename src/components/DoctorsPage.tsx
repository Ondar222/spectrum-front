...
export default function DoctorsPage() {
  ...
  const filteredDoctors = doctors?.filter((doctor: ArchimedDoctor) => {
    const matchesBranch =
      selectedBranch === "all" || String(doctor?.branch_id) === selectedBranch;
  ...
  if (isLoading && doctors.length === 0) {
    return (
      <div className="min-h-screen bg-secondary py-6 sm:py-8 md:py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3 sm:gap-4">
            <div className="md:col-span-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 pl-8 sm:pl-10 border border-gray-200 rounded focus:outline-none focus:border-primary text-sm sm:text-base"
                />
                <svg
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 sm:px-4 py-2 border border-gray-200 rounded focus:outline-none focus:border-primary text-sm sm:text-base"
              >
