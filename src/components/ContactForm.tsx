    ...
    >
      <div className="container mx-auto px-3 sm:px-4 relative z-10">
        <div className="max-w-6xl mx-auto bg-white/95 backdrop-blur-sm rounded-lg sm:rounded-2xl shadow-2xl p-3 sm:p-6 md:p-10 border border-white/20">
          <h2 className="text-lg sm:text-2xl font-bold text-center mb-3 sm:mb-6 text-dark">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 items-stretch">
            <form
              ...
              className="order-1 lg:order-2 lg:col-span-2 h-full flex flex-col"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-6 mb-3 sm:mb-6">
                <div>
                  <label
                    htmlFor="name"
                    className="block text-gray-700 mb-1 sm:mb-2 text-xs sm:text-base"
                  >
                    Ваше имя
                  </label>
                  <input
              ...
              <div className="mb-4 sm:mb-6">
                <label
                  className={`flex items-start space-x-2 sm:space-x-3 ${!formData.agreeToTerms && validationError ? "text-red-600" : ""}`}
                >
                  <input
                    type="checkbox"
                    name="agreeToTerms"
