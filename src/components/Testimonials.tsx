...
const testimonials: Testimonial[] = [
  {
    id: 1,
    text: 'Хочу выразить огромную благодарность врачам клиники Алданbcrypt! Очень профессиональные специалисты, внимательное отношение и современное оборудование. Всегда получаю квалифицированную помощь и подробные консультации по всем вопросам здоровья.',
    author: 'Ай-Кыс',
    date: '15.03.2023',
  },
  {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-3 sm:px-4 relative z-10">
        <h2 className="text-xl sm:text-2xl font-bold text-center mb-6 sm:mb-8 text-white">Отзывы пациентов</h2>
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-lg sm:rounded-xl shadow-xl p-4 sm:p-6 border border-white/20">
            <div className="flex justify-center mb-3 sm:mb-4">
              <svg className="text-teal h-6 w-6 sm:h-8 sm:w-8" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              <p className="font-bold text-dark text-sm sm:text-base">{testimonials[activeTestimonialIndex].author}</p>
              <p className="text-gray-500 text-xs sm:text-sm">{testimonials[activeTestimonialIndex].date}</p>
            </div>
          </div>
