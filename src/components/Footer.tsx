...
Центр СпектрУМ
            ...
            <p className="text-gray-200 mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base">
              Центр СпектрУМ — логопед, дефектолог, психолог, педагог в Кызыле.
              Развивающие занятия для детей с РАС и СДВГ. АПИ, Английский язык,
              коррекция нарушения речи. Работаем со всеми детьми, в том числе с
