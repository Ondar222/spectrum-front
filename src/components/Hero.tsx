...
const slides = [
  {
    ...
    subtitle: "логопед • дефектолог • психолог • педагог",
    description:
      "Развивающие занятия для детей с РАС и СДВГ. Логопед и дефектолог помогут преодолеть нарушение речи. АПИ, Английский язык, индивидуальные и групповые занятия в Кызыле.",
    buttonText: "НАШИ НАПРАВЛЕНИЯ",
    buttonLink: "/about",
    image: carousel,
  },
  {
    id: 2,
    title: "Диагностика и коррекция",
    subtitle: "Полная оценка развития за один визит",
    description:
      "Комплексное обследование у логопеда, дефектолога и психолога. Диагностика нарушений речи, когнитивных функций, подготовка к школе. Индивидуальные программы коррекции для детей с РАС и СДВГ.",
