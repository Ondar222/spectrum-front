...
const services: Service[] = [
  ...
  // },
  {
    ...
    desc: "Диагностика и коррекция при РАС, СДВГ и нарушении речи. Поддержка семей детей с особенностями развития.",
    bullets: [
      "диагностика РАС и СДВГ",
  ...
  },
  {
    ...
    desc: "В центре интеллектуального развития СпектрУМ ведет прием сурдопедагог Оюн Ася Мергеньевна — педагог, специалист по обучению и воспитанию детей с нарушениями слуха.",
    ...
    sections: [
      {
        ...
        text: "Во время диагностики логопед анализирует степень нарушения устной и письменной речи у дошкольников и школьников, проводит обследование фонематического слуха, состояния речевого аппарата. По результатам логопед разрабатывает индивидуальную программу коррекции выявленных нарушений — для детей с РАС, СДВГ и другими особенностями развития.",
        bulletsTitle: "Консультация логопеда рекомендуется, если ребенок:",
        bullets: [
      ...
      },
      {
        ...
        text: "Логопед проводит артикуляционную и пальчиковую гимнастику, логомассаж, упражнения для развития слухового внимания, постановку и автоматизацию звуков. Коррекция нарушений речи у детей с РАС, СДВГ. Развитие логограмматических представлений, речевого дыхания, подготовка к чтению и письму. Программа подбирается индивидуально.",
...
export default function ServiceGrid() {
  ...
  const medExams: Service = {
    ...
    hoverColor: "hover:bg-primaryDark",
    link: "/prices",
    desc: "Помощь детям с особенностями развития: формирование учебных навыков, развитие мышления и адаптация. Дефектолог работает с РАС, СДВГ, нарушением речи.",
    bullets: [
    ...
    <section className="py-6 sm:py-8 bg-white">
      <div className="container mx-auto px-3 sm:px-4">
        ...
        <p className="text-gray-600 text-center max-w-2xl mx-auto mb-6 sm:mb-8 text-xs sm:text-sm">
          Центр СпектрУМ предлагает образовательные и психологические услуги для
