    ...
    <div className="min-h-screen bg-lightTeal">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4">О нашей клинике</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Современная медицинская клиника, предоставляющая широкий спектр медицинских услуг с использованием передовых технологий и индивидуального подхода к каждому пациенту.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-semibold mb-4">Преимущества клиники</h2>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg className="w-6 h-6 text-teal mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-semibold mb-2">Профилактика</h3>
                  <p className="text-sm text-gray-600">Предупреждение заболеваний</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="font-semibold mb-2">Реабилитация</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-teal mb-2">10000+</div>
        ...
        {/* Contact Section */}
        <div className="bg-white rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-semibold mb-6 text-center">Контактная информация</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <svg className="w-8 h-8 text-teal mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">info@clinic.ru</p>
            </div>
          </div>
        </div>
      </div>
