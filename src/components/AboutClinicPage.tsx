    ...
    <div className="min-h-screen bg-gray-50 py-8 md:py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10 md:mb-16">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4 text-dark">О клинике Алдан</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-12 md:mb-16">
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              <h2 className="text-xl sm:text-2xl font-semibold mb-3 md:mb-4 text-dark">Наша миссия</h2>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              <h2 className="text-xl sm:text-2xl font-semibold mb-3 md:mb-4 text-dark">Преимущества клиники</h2>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              <h2 className="text-xl sm:text-2xl font-semibold mb-3 md:mb-4 text-dark">Наши направления</h2>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-dark">Диагностика</h3>
                  <p className="text-sm text-gray-600">Современные методы обследования</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-dark">Лечение</h3>
                  <p className="text-sm text-gray-600">Эффективные методы терапии</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-dark">Профилактика</h3>
                  <p className="text-sm text-gray-600">Предупреждение заболеваний</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-dark">Реабилитация</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
              <h2 className="text-xl sm:text-2xl font-semibold mb-3 md:mb-4 text-dark">Наши достижения</h2>
        ...
        {/* Contact Section */}
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          <h2 className="text-xl sm:text-2xl font-semibold mb-4 md:mb-6 text-center text-dark">Контактная информация</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 text-dark">Адрес</h3>
              <a
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 text-dark">Телефон</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 text-dark">Email</h3>
