  ...
  const directions = [
    {
      ...
      title: "Дефектология",
      description:
        "Дефектолог — специалист по развитию детей с РАС, СДВГ и нарушениями речи. Диагностика, коррекционно-развивающие занятия, подготовка к школе. Индивидуальные программы для каждого ребёнка.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Педагог по обучению детей с нарушением слуха. Развитие речи и коммуникации, подготовка к школе, работа с кохлеарными имплантами.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-5 w-5"
    ...
    },
    {
      ...
      title: "Психология",
      description:
        "Психолог — индивидуальные и семейные консультации для детей и взрослых. Развивающие занятия, коррекция поведения при СДВГ, помощь в адаптации.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-5 w-5"
    ...
    },
    {
      ...
      description:
        "Клинический психолог проводит диагностику РАС, СДВГ, нарушение речи. ЭПИ-заключения, поддержка семей, коррекция эмоциональных трудностей.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-5 w-5"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-700 max-w-3xl mx-auto">
            Центр СпектрУМ — образовательный центр для развития детей с РАС, СДВГ и особенностями речи. Наши специалисты: логопед, дефектолог, психолог, педагог. Развивающие занятия, АПИ, Английский язык, коррекция нарушения речи.
          </p>
        </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-600">
                    Логопед и дефектолог — коррекция нарушения речи
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="text-gray-600">
                    Развивающие занятия для детей с РАС и СДВГ
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="text-gray-600">
                    Психолог и педагог — индивидуальный подход
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span className="text-gray-600">
                    АПИ, Английский язык, подготовка к школе
                  </span>
                </li>
              </ul>
            </div>
